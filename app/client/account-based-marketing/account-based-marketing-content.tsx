...
export default function AccountBasedMarketingPageContent() {
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-lg shadow-md p-12 text-center">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-fo-dark mb-4">Account-Based Marketing</h1>
        ...
        <p className="text-lg font-normal text-fo-text-secondary mb-8 max-w-2xl mx-auto">
          Account-Based Marketing plays will help you target and engage specific high-value accounts with personalized campaigns.
        </p>
        ...
        <div className="bg-fo-light/50 rounded-lg p-6 text-left max-w-2xl mx-auto">
          ...
          <ul className="space-y-3 text-fo-text-secondary font-normal">
            <li className="flex items-start gap-3">
              ...
              <span>Targeted campaigns for specific accounts</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-fo-primary font-semibold">•</span>
              <span>Account-specific play execution</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-fo-primary font-semibold">•</span>
              <span>Personalized messaging for high-value prospects</span>
            </li>
          </ul>
        </div>
      </div>
