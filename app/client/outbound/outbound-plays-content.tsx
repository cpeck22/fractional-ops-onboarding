...
// Plays that are hidden from client view (none currently for outbound)
const HIDDEN_PLAYS_OUTBOUND: string[] = [];
  ...
  const loadPlays = useCallback(async () => {
    try {
      ...
      const filteredPlays = userIsAdmin 
        ? playsWithStatus 
        : playsWithStatus.filter((play: Play) => !HIDDEN_PLAYS_OUTBOUND.includes(play.code));
